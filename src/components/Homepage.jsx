      ...
      <div className="flex">
        ...
        <div className="flex-1 bg-background2 bg-opacity-30">
          <main className="min-h-screen">
            ...
            <div className="border border-4 border-red-800 m-4 p-2 grid grid-cols-1 gap-4 flex items-center justify-center md:grid md:grid-cols-2 md:gap-2 lg:grid lg:grid-cols-3">
              <div
                className="relative border border-4 border-red-800 md:h-96 md:w-60"
