            ...
            <div className="w-5/6  m-4 bg-white shadow-2xl rounded-md">
              <div className="h-60 w-full grid grid-cols-2">
                ...
                <div className="h-56 m-2 rounded-md">
                  <p className="text-center text-2xl font-heading font-medium p-2">
                    Title
                  </p>
                  <p className="text-center text-lg font-heading font-medium p-2">
                    Country
                  </p>
                  <p className="text-center text-lg font-heading font-medium p-2">
                    Rating
              ...
              <div className="h-96 w-full ">
                ...
                <ul className="ml-8 font-serif text-lg font-light font-paragraph list-decimal">
                  <li>Ingredient 1</li>
                  <li>Ingredient 1</li>
                  <li>Ingredient 1</li>
                  <li>Ingredient 1</li>
              ...
              <div className="h-96 w-full">
                ...
                <ul className="ml-8 font-serif text-lg font-light font-paragraph list-disc">
                  <li>Step 1</li>
                  <li>Step 1</li>
                  <li>Step 1</li>
                  <li>Step 1</li>
