...
const navigation = [
  ...
  { name: "Saved", href: "/saved", icon: StarIcon, current: false },
  {
    name: "Profile",
    href: "/my-profile",
    icon: UserCircleIcon,
    ...
    <>
      <div>
        ...
        <div className="flex flex-1 flex-col md:pl-64">
          <div className="sticky top-0 z-10 bg-background2 bg-opacity-30 h-[100vh] pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden">
            <button
              type="button"
